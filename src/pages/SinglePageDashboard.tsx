        ...
        return (
          <div className="space-y-8">
            <div className="text-center py-16">
              <h1 className="text-4xl font-bold text-blue-900 mb-4">Welcome to Your Restaurant Dashboard</h1>
              <p className="text-xl text-blue-700 mb-8">Manage your restaurant information and settings from here.</p>
              ...
              <nav className="flex-1 px-2 py-4 space-y-1">
                {navigation.map((item) => (
                  ...
                  >
                    <item.icon
                      className={`${
                        activeSection === item.href ? 'text-yellow-300' : 'text-blue-300'
